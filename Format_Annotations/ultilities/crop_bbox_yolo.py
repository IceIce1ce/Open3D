...
def crop_from_all_cam_each_scene(scene_name):
...
def run_multi_thread():
	...
	for scene_name in list_scene:
		# t = threading.Thread(target=crop_from_all_cam_each_scene, args=(scene_name,))
...
def run_single_thread():
	...
	for scene_name in tqdm(list_scene):
		# crop_from_all_cam_each_scene(scene_name)
